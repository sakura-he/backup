...
let colorMode = themeCache.getCache(CACHE_MODE_NAME) || colorModeEnum["AUTO"]; // 本地没有找到默认为 auto
...
export default function useDarkMode() {
	...
	// 返回封装好的手动切换主题函数
	return { setColorMode, value, isDarkMode, lightTheme, themeChangeCallback };
}
